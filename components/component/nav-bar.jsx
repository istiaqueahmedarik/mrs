 ...
 const path = usePathname();
  ...
  return (
    ...
    <div className="flex items-center space-x-5">
      <Image placeholder="blur" blurDataURL="/iconblur.jpg" alt="" className="w-10 h-10 rounded-full" height={100} width={100} src="/icon.jpg"/>
        ...
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            <NavigationMenuLink
              ...
              href="/mediaOutreach">
               <Image placeholder="blur" blurDataURL="/iconblur.jpg"PlusIcon className="grid md:hidden lg:hidden sm:grid" size={18} /> <div className="hidden sm:hidden md:grid lg:grid">Media Outreach</div> 
            </NavigationMenuLink>
          </NavigationMenuItem>
          <NavigationMenuItem>
            <NavigationMenuLink
